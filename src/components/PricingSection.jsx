  ...
  return (
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10 px-4">
        ...
        {/* 🎯 Join TECH.AI Today Section - Moved below pricing */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="mt-20 flex flex-col lg:flex-row items-center gap-10 bg-gradient-to-br from-purple-900/30 via-blue-900/20 to-pink-900/30 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl"
        >
          {/* Image Side */}
        ...
        {/* 🎮 Gaming & Productivity Section - Now right below Join TECH.AI */}
        <motion.div
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="mt-20 flex flex-col lg:flex-row items-center gap-10 bg-gradient-to-br from-green-900/20 via-blue-900/20 to-purple-900/20 backdrop-blur-xl rounded-3xl p-8 border border-white/10 shadow-2xl"
        >
          {/* Image Side */}
          <div className="lg:w-1/2 flex justify-center">
            <motion.img
